...
render_player_col:	PROCEDURE
	IF (LINES(X) AND &10000000)>0 THEN PRINT AT 40+20*0+X COLOR 2, "*" ELSE PRINT AT 40+20*0+X , " "
	IF (LINES(X) AND &01000000)>0 THEN PRINT AT 40+20*1+X COLOR 2, "*" ELSE PRINT AT 40+20*1+X , " "
	IF (LINES(X) AND &00100000)>0 THEN PRINT AT 40+20*2+X COLOR 2, "*" ELSE PRINT AT 40+20*2+X , " "
	IF (LINES(X) AND &00010000)>0 THEN PRINT AT 40+20*3+X COLOR 2, "*" ELSE PRINT AT 40+20*3+X , " "
	IF (LINES(X) AND &00001000)>0 THEN PRINT AT 40+20*4+X COLOR 2, "*" ELSE PRINT AT 40+20*4+X , " "
	IF (LINES(X) AND &00000100)>0 THEN PRINT AT 40+20*5+X COLOR 2, "*" ELSE PRINT AT 40+20*5+X , " "
	IF (LINES(X) AND &00000010)>0 THEN PRINT AT 40+20*6+X COLOR 2, "*" ELSE PRINT AT 40+20*6+X , " "
	IF (LINES(X) AND &00000001)>0 THEN PRINT AT 40+20*7+X COLOR 2, "*" ELSE PRINT AT 40+20*7+X , " "
